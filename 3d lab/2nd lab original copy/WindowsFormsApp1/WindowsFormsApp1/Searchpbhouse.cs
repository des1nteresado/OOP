...
{
    public partial class Searchpbhouse : Form
    {
        public Searchpbhouse()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (FileStream fs = new FileStream("books.xml", FileMode.OpenOrCreate))
            {
                ...
                {
                    if (bk.Pubname.Contains(textBox1.Text))
                    {
                        test = false;
                ...
                if (!test)
                {
                    ...
                    using (FileStream fs2 = new FileStream("Search by pbhouse.xml", FileMode.OpenOrCreate))
                    {
